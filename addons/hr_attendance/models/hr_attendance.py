...
from inphms.tools import _, format_datetime, format_time, format_duration
from inphms.tools.intervals import Intervals
from inphms.orm.fields import Domain
from inphms.tools.convertutils import convert_file
from inphms import exceptions
...
class HrAttendance(models.Model):
    ...
    def write(self, vals):
        if vals.get('employee_id') and \
            ...
            raise exceptions.AccessError(_("Do not have access, user cannot edit the attendances that are not his own."))
    ...
    def _load_demo_data(self):
        ...
        convert_file(env_sudo, 'hr_attendance', 'data/scenarios/hr_attendance_scenario.xml', None, mode='init')
