...
from .res_partner import SignupError
...
class ResUsers(models.Model):
    ...
    def _action_reset_password(self, signup_type="reset"):
        ...
        print(create_mode, [user for user in self], [user._is_internal() for user in self])
        if create_mode:
            if any(user._is_internal() for user in self):
                ...
                print(internal_account_created_template)
