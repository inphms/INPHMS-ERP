...
from inphms.tools import _, LazyTranslate
from inphms.exceptions import UserError
from inphms.addons.web.controllers.home import Home, ensure_db, SIGN_UP_REQUEST_PARAMS, LOGIN_SUCCESSFUL_PARAMS
from inphms.addons.web.models.res_users import SKIP_CAPTCHA_LOGIN
from inphms.addons.auth_signup.models.res_users import SignupError
from inphms.addons.base_setup.controllers.main import BaseSetup
...
class AuthSignupHome(Home):
    ...
    @route('/web/signup', type='http', auth='public', website=True, sitemap=False, captcha='signup', list_as_website_content=_lt("Sign Up"))
    ...
    @route('/web/reset_password', type='http', auth='public', website=True, sitemap=False, captcha='password_reset', list_as_website_content=_lt("Reset Password"))
    ...
    def get_auth_signup_config(self):
        ...
        return {
            'disable_database_manager': not config['db_manager'],
