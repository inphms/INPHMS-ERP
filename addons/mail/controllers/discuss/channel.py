...
class ChannelController(Controller):
    @route("/discuss/channel/members", methods=["POST"], type="jsonrpc", auth="public", readonly=True)
    ...
    @route("/discuss/channel/update_avatar", methods=["POST"], type="jsonrpc")
    ...
    @route("/discuss/channel/messages", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
    ...
    @route("/discuss/channel/pinned_messages", methods=["POST"], type="jsonrpc", auth="public", readonly=True)
    @add_guest_to_context
    ...
    @route("/discuss/channel/mark_as_read", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
    ...
    @route("/discuss/channel/set_new_message_separator", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
    ...
    @route("/discuss/channel/notify_typing", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
    ...
    @route("/discuss/channel/attachments", methods=["POST"], type="jsonrpc", auth="public", readonly=True)
    @add_guest_to_context
    ...
    @route("/discuss/channel/join", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
    ...
    @route("/discuss/channel/sub_channel/create", methods=["POST"], type="jsonrpc", auth="public")
    ...
    @route("/discuss/channel/sub_channel/fetch", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
    ...
    @route("/discuss/channel/sub_channel/delete", methods=["POST"], type="jsonrpc", auth="user")
