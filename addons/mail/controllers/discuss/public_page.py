...
from inphms.tools import consteq, email_normalize, replace_exceptions, verify_hash_signed, _
...
class PublicPageController(Controller):
    ...
    @route("/chat/<int:channel_id>/<string:invitation_token>", methods=["GET"], type="http", auth="public")
    @add_guest_to_context
    ...
    @route("/discuss/channel/<int:channel_id>", methods=["GET"], type="http", auth="public")
    @add_guest_to_context
