...
class LinkPreviewController(Controller):
    @route("/mail/link_preview", methods=["POST"], type="jsonrpc", auth="public")
    ...
    @route("/mail/link_preview/hide", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
