...
from inphms.tools import verify_limited_field_access_token
...
class ThreadController(Controller):
    ...
    @route("/mail/thread/recipients", methods=["POST"], type="jsonrpc", auth="user")
    ...
    @route("/mail/thread/recipients/fields", methods=["POST"], type="jsonrpc", auth="user")
    ...
    @route("/mail/thread/recipients/get_suggested_recipients", methods=["POST"], type="jsonrpc", auth="user")
    ...
    @route("/mail/partner/from_email", methods=["POST"], type="jsonrpc", auth="user")
    ...
    @route("/mail/read_subscription_data", methods=["POST"], type="jsonrpc", auth="user")
    ...
    @route("/mail/message/update_content", methods=["POST"], type="jsonrpc", auth="public")
    @add_guest_to_context
    ...
    @route("/mail/thread/unsubscribe", methods=["POST"], type="jsonrpc", auth="user")
    ...
    @route("/mail/thread/subscribe", methods=["POST"], type="jsonrpc", auth="user")
