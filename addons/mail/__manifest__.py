...
Communicate with your colleagues/customers/guest within Inphms.

Talks/Chat
------------
User-friendly "Talks" features that allows one 2 one or group communication
...
from Inphms itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Inphms system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Inphms documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Inphms integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Inphms, and the
answers will automatically be collected when they come back, and attached to the
same *conversation* document.
For more specific needs, you may also assign custom-defined actions
(technically: Server Actions) to be triggered for each incoming mail.
    """,
    'website': 'https://www.inphms.com/app/Talks',
    'depends': ['base', 'base_setup', 'bus', 'web_tour', 'html_editor', 'web_mobile'],
    'data': [
    ...
    'assets': {
        ...
        'mail.assets_inphms_sfu': [
            'mail/static/lib/inphms_sfu/inphms_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/inphms_ui_icons/style.css',
