...
export class Thread extends Component {
    ...
    get startMessageSubtitle() {
        ...
        if (this.props.thread.channel_type === "channel") {
            return _t("Collaborate seamlessly across tasks and conversations. Start chatting with #%(channelName)s channel to stay on top of your work.", {
                channelName: this.props.thread.name,
            });
        }
        if (this.props.thread.channel_type === "channel") {
            return _t("Collaborate seamlessly across tasks and conversations. Start chatting with your %(conversationName)s group to stay on top of your work.", {
                conversationName: this.props.thread.displayName,
            });
        }
        return _t("Collaborate seamlessly across tasks and conversations. Start chatting with %(userName)s", {
