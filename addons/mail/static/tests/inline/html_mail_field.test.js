...
import { after, before, beforeEach, expect, test } from "@inphms/hoot";
import { press, queryOne } from "@inphms/hoot-dom";
import { animationFrame, enableTransitions } from "@inphms/hoot-mock";
import {
    clickSave,
    contains,
    defineModels,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".inphms-editor-editable").toHaveInnerHTML("<h1> first </h1>");
