...
registry.category("web_tour.tours").add("can_create_channel_from_form_view", {
    steps: () => [
        {
            trigger: ".o-mail-DiscussSidebarChannel-itemName:contains(InphmsBot)",
            run: "click",
        },
        {
            trigger: ".o-mail-DiscussContent-threadName[title='InphmsBot']",
        },
        ...
        {
            trigger: ".breadcrumb-item:contains('InphmsBot')",
            run: "click",
        },
        {
