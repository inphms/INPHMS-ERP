    ...
    steps: () => [
        {
            ...
            async run() {
                const composerService = inphms.__WOWL_DEBUG__.root.env.services["mail.composer"];
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.inphms-editor-editable",
            run: "editor Hello",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.inphms-editor-editable strong:contains(Hello)",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_mail_composer_message .inphms-editor-editable",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.inphms-editor-editable em:contains(Hello)",
        },
    ],
});
