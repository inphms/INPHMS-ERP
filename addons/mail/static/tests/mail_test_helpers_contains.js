/** @inphms-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@inphms/hoot";
import { queryAll, queryFirst } from "@inphms/hoot-dom";
 ...
 *  element.
 * @property {HTMLElement|InphmsEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when InphmsEnv, special key `target`. See @start
