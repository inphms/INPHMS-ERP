...
import { after, before, expect, getFixture, registerDebugInfo, test } from "@inphms/hoot";
import { hover as hootHover, queryFirst, resize } from "@inphms/hoot-dom";
import { Deferred, microTick } from "@inphms/hoot-mock";
import {
    MockServer,
    asyncStep,
    authenticate,
...
import { Component, onMounted, onPatched, onWillDestroy, status } from "@inphms/owl";
 ...
 *
 * @param {Object} param0
 * @param {Partial<InphmsEnv>} param0.env
