...
import { click as hootClick, press, queryFirst } from "@inphms/hoot-dom";
...
test("show new message separator on receiving new message when out of inphms focus", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "Foreigner partner" });
