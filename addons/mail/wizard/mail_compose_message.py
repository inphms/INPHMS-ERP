...
from inphms.tools import clean_context, _, split_every
from inphms.orm import fields, models, api
from inphms.tools.mailutils import is_html_empty, email_normalize, email_split_and_format, email_split_and_format_normalize
...
class MailComposeMessage(models.TransientModel):
    ...
    def _action_send_mail_mass_mail(self, res_ids, auto_commit=False):
        ...
        for res_ids_iter in split_every(batch_size, res_ids):
    ...
    def _generate_mail_notification_values(self, mails):
        ...
        for mail, notif_base_values in zip(mails, mails._get_notification_values()):
            emails = set(email_split_and_format_normalize(f'{mail.email_to or ""}, {mail.email_cc or ""}'))
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an Inphms domain (list of leaves) """
        self.ensure_one()
