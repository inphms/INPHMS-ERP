...
from inphms.tools import _, format_duration, formataddr, urls, format_amount
from inphms.tools.mailutils import is_html_empty, prepend_html_content, html_normalize
from inphms.tools.rendering_tools import convert_inline_template_to_qweb, parse_inline_template, render_inline_template, template_env_globals
...
class MailRenderMixin(models.AbstractModel):
    ...
    def _render_eval_context(self):
        ...
        render_context = {
            ...
            'format_amount': lambda amount, currency, lang_code=False: format_amount(self.env, amount, currency, lang_code),
