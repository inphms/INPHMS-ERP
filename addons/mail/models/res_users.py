...
from inphms.tools import _, email_normalize, str2bool
...
class ResUsers(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- In Inphms: notifications appear in your Inphms Inbox")
    ...
    _notification_type = models.Constraint(
        ...
        'Only internal user can receive notifications in Inphms',
    )
    ...
    def _init_store_data(self, store: Store):
        ...
        # sudo: res.partner - exposing InphmsBot data is considered acceptable
        inphmsbot = self.env.ref("base.partner_root").sudo()
        if not self.env.user._is_public():
            inphmsbot = inphmsbot.with_prefetch((inphmsbot + self.env.user.partner_id).ids)
    ...
    def _get_activity_groups(self):
        ...
        for model_name, activities in activities_model_groups.items():
            ...
            icon = module and get_module_icon(module)
