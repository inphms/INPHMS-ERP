...
class ResCompany(models.Model):
    ...
    email_secondary_color = fields.Char(
        "Email Button Color", default="#aa1e36",
        readonly=False)
    ...
    def _compute_bounce(self):
        ...
        for company in self.filtered('alias_domain_id'):
            ...
            company.bounce_formatted = formataddr((company.name, bounce_email))
    ...
    def _compute_catchall(self):
        ...
        for company in self.filtered('alias_domain_id'):
            ...
            company.catchall_formatted = formataddr((company.name, catchall_email))
