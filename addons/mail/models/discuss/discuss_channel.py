...
from inphms.tools import _, hash_sign, OrderedSet, format_list, email_normalize, html_escape
...
from inphms.addons.base.models.avatar_mixin import get_hsl_from_seed
...
class DiscussChannel(models.Model):
    ...
    def _notify_get_recipients(self, message, msg_vals=False, **kwargs):
        ...
        if pids:
            email_from = email_normalize(msg_vals.get('email_from') or message.email_from)
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        return {
            "type": "ir.actions.act_url",
            "url": f"/inphms/action-mail.action_discuss?active_id={self.id}",
            "target": "self",
        }
