...
from inphms.addons.base.models import ir_http
from inphms.addons.base.models.ir_http import RequestUID
from inphms.addons.base.models.ir_qweb import keep_query
from inphms.addons.base.models.res_lang import LangData
from inphms.exceptions import AccessError, MissingError, UserError
from inphms.orm.fields import Domain
from inphms.tools import ormcache, urls as tools_urls
from inphms.server import root, Response
...
class IrHttp(models.AbstractModel):
    ...
    def _url_localized(cls,
        ...
        if canonical_domain:
            ...
            return tools_urls.urljoin(canonical_domain, path)
