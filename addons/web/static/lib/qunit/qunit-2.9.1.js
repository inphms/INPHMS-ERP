...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("InphmsBeforeTestHook", "InphmsAfterTestHook"); // Inphms customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("InphmsBeforeTestHook"); // Inphms customization
