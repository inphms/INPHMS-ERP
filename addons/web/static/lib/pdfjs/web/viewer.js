...
class BasePreferences {
  #defaults = Object.freeze({
    ...
    // Inphms: don't support scripting (#115302)
    enableScripting: false,
    // Inphms: disable stamp editor
    enableUpdatedAddImage: false,
    // INPHMS: open links in new tabs to keep inphms document (#84594)
...
class PDFPrintService {
  ...
  layout() {
    ...
    // INPHMS PATCH PRINT PREVIEW MOBILE
...
window.print = function () {
  ...
  try {
    ...
    // INPHMS: FIX MOBILE PRINT PREVIEW
