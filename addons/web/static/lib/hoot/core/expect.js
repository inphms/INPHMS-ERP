...
import { markRaw } from "@inphms/owl";
import {
    formatXml,
    getActiveElement,
    getNodeAttribute,
 ...
 *
 * @typedef {import("@inphms/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@inphms/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@inphms/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@inphms/hoot-dom").QueryTextOptions} QueryTextOptions
 * @typedef {import("@inphms/hoot-dom").Target} Target
 */
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/inphms/i);
     */
