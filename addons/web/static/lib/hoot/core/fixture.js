...
import { animationFrame } from "@inphms/hoot-dom";
import { App } from "@inphms/owl";
...
/**
 * @typedef {Parameters<typeof import("@inphms/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@inphms/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@inphms/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@inphms/owl").Component} target
 */
