...
test("documentation_link: absolute path (http)", async () => {
    await mountView({
        ...
        arch: /* xml */ `
            <form>
                <field name="bar"/>
                <widget name="documentation_link" path="http://www.inphms.com/"/>
            </form>`,
    });
    expect(".o_doc_link").toHaveAttribute("href", "http://www.inphms.com/");
});
...
test("documentation_link: absolute path (https)", async () => {
    await mountView({
        ...
        <form>
            <field name="bar"/>
            <widget name="documentation_link" path="https://www.inphms.com/"/>
        </form>`,
    });

    expect(".o_doc_link").toHaveAttribute("href", "https://www.inphms.com/");
});
