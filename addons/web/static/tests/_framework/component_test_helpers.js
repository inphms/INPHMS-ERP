import { after, destroy, getFixture, queryFirst, queryOne } from "@inphms/hoot";
import { App, Component, xml } from "@inphms/owl";
 ...
 * @typedef {import("@inphms/owl").Component} Component
 * @typedef {import("@web/env").InphmsEnv} InphmsEnv
 *
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@inphms/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
 ...
 * @template [P={}]
 * @template [E=InphmsEnv]
 * @param {C | string} ComponentClass
 * @param {AppConfig & {
 *  componentEnv?: Partial<InphmsEnv>;
 *  containerEnv?: Partial<InphmsEnv>;
