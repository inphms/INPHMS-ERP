...
import { after, before, beforeEach, createJobScopedGetter } from "@inphms/hoot";
import { validateType } from "@inphms/owl";

const { view_info } = inphms.__session_info__ || {};
delete inphms.__session_info__;
...
const SERVER_STATE_VALUES_SCHEMA = {
    ...
    lang: String,
    multiLang: Boolean,
    inphmsbotId: [Number, { value: false }],
