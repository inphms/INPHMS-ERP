...
/**
 * @typedef {import("@inphms/hoot").DragHelpers} DragHelpers
 * @typedef {import("@inphms/hoot").DragOptions} DragOptions
 * @typedef {import("@inphms/hoot").FillOptions} FillOptions
 * @typedef {import("@inphms/hoot").InputValue} InputValue
 * @typedef {import("@inphms/hoot").KeyStrokes} KeyStrokes
 * @typedef {import("@inphms/hoot").PointerOptions} PointerOptions
 * @typedef {import("@inphms/hoot").Position} Position
 * @typedef {import("@inphms/hoot").QueryOptions} QueryOptions
 * @typedef {import("@inphms/hoot").Target} Target
 *
 * @typedef {DragOptions & {
