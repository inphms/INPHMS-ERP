...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        inphms.define = this.define.bind(this);
        inphms.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@inphms` (`inphms/o-spreadsheet)
     * To ensure that this module is loaded, we have to include `inphms` in the dependencies
     */
    spreadsheet: ["inphms"],
    /**
...
const CSRF_TOKEN = inphms.csrf_token;
...
const R_DEFAULT_MODULE = /^@inphms\/(owl|hoot)/;
