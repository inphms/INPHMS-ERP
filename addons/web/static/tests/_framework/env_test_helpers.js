import { after, afterEach, beforeEach, registerDebugInfo } from "@inphms/hoot";
 ...
 *
 * @param {Partial<InphmsEnv>} [partialEnv]
 * @param {{
 *  makeNew?: boolean;
 * }} [options]
 */
 ...
 *  (env: InphmsEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
