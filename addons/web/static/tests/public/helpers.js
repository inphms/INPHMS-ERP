import { getFixture, after } from "@inphms/hoot";
...
export async function startInteractions(
    ...
    if (inphms.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = inphms.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
