import { beforeEach, expect, getFixture, test } from "@inphms/hoot";
import { microTick, tick } from "@inphms/hoot-dom";
...
/** @type {typeof InphmsModuleLoader} */
const ModuleLoader = Object.getPrototypeOf(inphms.loader.constructor);
