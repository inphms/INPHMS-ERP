import { destroy, expect, test } from "@inphms/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@inphms/hoot-dom";
import { animationFrame } from "@inphms/hoot-mock";
import { Component, onMounted, useState, xml } from "@inphms/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
