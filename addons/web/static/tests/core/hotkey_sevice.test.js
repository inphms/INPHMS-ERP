import { destroy, expect, getFixture, onError, test } from "@inphms/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@inphms/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@inphms/hoot-mock";
import { Component, useRef, useState, xml } from "@inphms/owl";
import {
    contains,
    getService,
    makeMockEnv,
