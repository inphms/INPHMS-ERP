...
test("escape", () => {
    ...
    expect(escape(`<a href="https://www.inphms.com"inphms<a>`)).toBe(
        `&lt;a href=&quot;https://www.inphms.com&quot;&gtinphms&lt;a&gt;`
    );
    expect(escape(`<a href='https://www.inphms.com'inphms<a>`)).toBe(
        `&lt;a href=&#x27;https://www.inphms.com&#x27;&gtinphms&lt;a&gt;`
    );
    expect(escape("<a href='https://www.inphms.com'>Inphms`s website<a>")).toBe(
        `&lt;a href=&#x27;https://www.inphms.com&#x27;&gt;Inphms&#x60;s website&lt;a&gt;`
    );
});
...
test("escapeRegExp", () => {
    ...
    expect(escapeRegExp("[wowl]")).toBe("\\[wowl\\]");
    expect(escapeRegExp("[wowl.inphms]")).toBe("\\[wowl\\inphms\\]");
    expect(escapeRegExp("^inphms.define([.]*)$")).toBe("\\inphms\\.define\\(\\[\\.\\]\\*\\)\\$");
    expect(escapeRegExp("[.*+?^${}()|[]\\")).toBe("\\[\\.\\*\\+\\?\\^\\$\\{\\}\\(\\)\\|\\[\\]\\\\");
});
...
test("isEmail", () => {
    ...
    expect(isEmail("test@inphms")).toBe(false);
    expect(isEmail("test@inphmsinphms.com")).toBe(false);
    expect(isEmail("te st@inphms.com")).toBe(false);

    expect(isEmail("test@inphms.com")).toBe(true);
});
