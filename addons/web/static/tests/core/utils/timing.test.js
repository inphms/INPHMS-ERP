import { describe, destroy, expect, getFixture, test } from "@inphms/hoot";
import { click, tick } from "@inphms/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@inphms/hoot-mock";
