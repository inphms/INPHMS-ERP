...
import { mockFetch } from "@inphms/hoot-mock";
...
test("PWA installation process", async () => {
    ...
    expect(pwaService.canPromptToInstall).toBe(false);
    expect.verifySteps(['{"/inphms":"accepted"}', "onDone call with installation accepted"]);
});
