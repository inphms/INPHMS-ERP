...
import { press, queryAll, queryAllAttributes, queryAllTexts, queryOne } from "@inphms/hoot-dom";
import { animationFrame, mockDate, mockTimeZone, runAllTimers } from "@inphms/hoot-mock";
import { Component, useState, xml } from "@inphms/owl";
