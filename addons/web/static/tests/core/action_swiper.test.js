/** @inphms-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@inphms/hoot";
import { hover, queryFirst } from "@inphms/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@inphms/hoot-mock";
import { Component, onPatched, xml } from "@inphms/owl";
import {
    contains,
    defineParams,
    mountWithCleanup,
