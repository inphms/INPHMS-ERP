/** @inphms-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@inphms/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await inphms.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (inphms.debug &&inphms.debug.includes("assets")) {
    ...
    QUnit.on("InphmsAfterTestHook", (info) => {
