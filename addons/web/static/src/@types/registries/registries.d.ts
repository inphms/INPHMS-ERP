declare module "registries" {
    ...
    export type ActionsRegistryItemShape = (((env: InphmsEnv, action: ActionDescription) => void) | typeof Component) & {
        displayName?: string;
        path?: string;
        target?: ActionMode;
    };
    ...
    export interface CogMenuRegistryItemShape {
        ...
        groupNumber: number;
        isDisplayed?: (env: InphmsEnv) => boolean;
    }

    export type DialogsRegistryItemShape = typeof Component;

    export type EffectsRegistryItemShape = (env: InphmsEnv, params: object) => ({ Component: typeof Component, props: object } | undefined);

    export type ErrorDialogsRegistryItemShape = typeof Component;

    export type ErrorHandlersRegistryItemShape = (env: InphmsEnv, error: Error, originalError: Error) => boolean;
    ...
    export type IrActionsReportHandlers = (action: ActionRequest, options: ActionOptions, env: InphmsEnv) => (void | boolean | Promise<void | boolean>);
