...
/** @extends Component<ListRendererProps, InphmsEnv> */
export class ListRenderer extends Component {
    ...
    setup() {
        ...
        const isPotentiallyEditable = !isMobileOS() && !this.env.inDialog && user.isSystem && list === list.model.root && actionId && actionType === "ir.actions.act_window";
    ...
    get displayOptionalFields() {
        return this.isStudioEditable() || this.hasOptionalFields;
    }
