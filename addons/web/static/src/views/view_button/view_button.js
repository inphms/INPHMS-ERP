...
const inphmsToBootstrapClasses = {
...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(inphms.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in inphmsToBootstrapClasses) {
                    cls = inphmsToBootstrapClasses[cls];
                }
                classNames.push(cls);
