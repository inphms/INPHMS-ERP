...
import { Component, useRef, useState, markup } from "@inphms/owl";
...
export const inphmsExceptionTitleMap = new Map(
    Object.entries({
        "inphms.addons.base.models.ir_mail_server.MailDeliveryException": _t("MailDeliveryException"),
        "inphms.exceptions.AccessDenied": _t("Access Denied"),
        "inphms.exceptions.MissingError": _t("Missing Record"),
        "inphms.addons.web.controllers.action.MissingActionError": _t("Missing Action"),
        "inphms.addons.base.models.ir_actions.ServerActionWithWarningsError": _t("Invalid Operation"),
        "inphms.exceptions.UserError": _t("Invalid Operation"),
        "inphms.exceptions.ValidationError": _t("Validation Error"),
        "inphms.exceptions.AccessError": _t("Access Error"),
        "inphms.exceptions.Warning": _t("Warning"),
    })
);
...
ClientErrorDialog.title = _t("Inphms Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("Inphms Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        if (this.props.exceptionName && inphmsExceptionTitleMap.has(this.props.exceptionName)) {
            this.title = inphmsExceptionTitleMap.get(this.props.exceptionName).toString();
            return;
        }
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("Inphms Server Error");
                break;
            case "script":
                this.title = _t("Inphms Client Error");
                break;
            case "network":
                this.title = _t("Inphms Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        if (this.props.exceptionName && inphmsExceptionTitleMap.has(this.props.exceptionName)) {
            return inphmsExceptionTitleMap.get(this.props.exceptionName).toString();
        }
        return this.props.title || _t("Inphms Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    ...
    setup() {
        ...
        this.title = capitalize(subType) || _t("Inphms Warning");
        this.message = message;
...
registry
    ...
    .add("inphms.exceptions.AccessDenied", WarningDialog)
    .add("inphms.exceptions.AccessError", WarningDialog)
    .add("inphms.exceptions.MissingError", WarningDialog)
    .add("inphms.addons.web.controllers.action.MissingActionError", WarningDialog)
    .add("inphms.addons.base.models.ir_actions.ServerActionWithWarningsError", WarningDialog)
    .add("inphms.exceptions.UserError", WarningDialog)
    .add("inphms.exceptions.ValidationError", WarningDialog)
    .add("inphms.exceptions.RedirectWarning", RedirectWarningDialog)
    .add("inphms.http.SessionExpiredException", SessionExpiredDialog)
