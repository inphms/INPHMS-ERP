...
import { Component, onWillStart } from "@inphms/owl";
...
export class ResConfigDevTool extends Component {
    ...
    setup() {
        this.isDebug = Boolean(inphms.debug);
        this.isAssets = inphms.debug.includes("assets");
        this.isTests = inphms.debug.includes("tests");
