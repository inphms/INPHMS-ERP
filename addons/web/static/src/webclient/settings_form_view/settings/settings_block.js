...
import { Component, useState, useRef, useEffect, onWillRender, useChildSubEnv } from "@inphms/owl";
...
export class SettingsBlock extends Component {
    ...
    setup() {
        ...
        this.settingsContainerWrapperRef = useRef("settingsContainerWrapper");
    ...
    toggleContainer(force) {
        ...
        this.settingsContainerWrapperRef.el.classList.toggle("d-none", force);
