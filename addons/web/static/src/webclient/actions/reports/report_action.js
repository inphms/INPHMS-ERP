...
import { Component, useRef, useSubEnv } from "@inphms/owl";
 ...
 * It uses a feature to automatically create links to other inphms pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
