...
import { App, reactive } from "@inphms/owl";
...
function setup(light, currentState) {
    env = inphms.__WOWL_DEBUG__.root.env;
    ...
    isEnterprise = inphms.info &&inphms.info.isEnterprise;
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Inphms flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
