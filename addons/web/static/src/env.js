import { App, EventBus } from "@inphms/owl";
...
/**
 * Return a value Inphms Env object
 *
 * @returns {InphmsEnv}
 */
 ...
 * in `__WOWL_DEBUG__`
 *
 * @param {import("@inphms/owl").Component} component the component to mount
