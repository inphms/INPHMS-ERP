...
from inphms.tools import osutils
from inphms.server import Controller, route, content_disposition
from inphms.server.utils import request, serialize_exception
...
class ExportFormat(object):
    ...
    def from_data(self, fields, columns_headers, rows):
        """ Conversion method from Inphms's export data to whatever the
    ...
    def base(self, data):
        ...
        return request.make_response(response_data,
            headers=[('Content-Disposition',
                            content_disposition(
                                osutils.clean_filename(self.filename(model) + self.extension))),
