...
class WebJsonController(Controller):
    ...
    @route('/json/1/<path:subpath>', auth='bearer', type='http', readonly=True)
    def web_json_1(self, subpath, **kwargs):
        ...
        in the web client for the same /inphms `subpath`.
