...
""",
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'web/static/lib/inphms_ui_icons/*',
            'web/static/lib/material_ui_icons/*',
        ...
        'web.assets_frontend': [
            ...
            'web/static/lib/owl/inphms_module.js',
        ...
        "web.assets_web_dark": [
            ...
            ('after', 'web/static/src/scss/primary_variables.scss', 
                'web/static/src/**/*.variables.dark.scss'),

            ('before', 'web/static/src/scss/secondary_variables.scss',
                'web/static/src/scss/secondary_variables.dark.scss'),
