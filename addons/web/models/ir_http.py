...
from inphms.server.utils import request, DEFAULT_MAX_CONTENT_LENGTH
from inphms.tools import hmac, str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def color_scheme(self):
        ...
        user_scheme = self.env.user.color_scheme
        if user_scheme in ('light', 'dark'):
            return user_scheme
        elif user_scheme == 'system' and color_scheme:
            return color_scheme
        return 'light'
    ...
    def session_info(self):
        ...
        version_info = inphms.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.inphms.com/buy",
            "name": user.name,
            "username": user.login,
