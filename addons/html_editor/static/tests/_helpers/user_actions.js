...
import { click, manuallyDispatchProgrammaticEvent, press, tick, waitFor } from "@inphms/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteInphmsEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.inphms.inphms-editor");
}
/**
