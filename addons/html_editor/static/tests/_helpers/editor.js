...
import { destroy, expect, getFixture } from "@inphms/hoot";
import { queryOne } from "@inphms/hoot-dom";
import { Component, markup, onWillDestroy, xml } from "@inphms/owl";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.inphms-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("inphms-editor-editable");
