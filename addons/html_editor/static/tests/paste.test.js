...
import { manuallyDispatchProgrammaticEvent as dispatch, press, waitFor } from "@inphms/hoot-dom";
import { animationFrame, tick } from "@inphms/hoot-mock";
...
import { pasteHtml, pasteInphmsEditorHtml, pasteText, undo } from "./_helpers/user_actions";
...
describe("Unwrapping html element", () => {
    ...
    test("should unwrap li elements having no ul/ol", async () => {
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteInphmsEditorHtml(editor, "<li><p>abc</p></li><li><p>def</p></li>");
            },
            contentAfter: "<p>abc</p><p>def[]</p>",
        });
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteInphmsEditorHtml(editor, "<li><h1>abc</h1></li><li><h1>def</h1></li");
            },
...
describe("Special cases", () => {
    describe("lists", () => {
        ...
        test("should paste a deeply nested list copied outside from inphms", async () => {
            await testEditor({
                contentBefore: "<ul><li>[]<br></li></ul>",
                stepFunction: async (editor) => {
                    pasteHtml(
...
const url = "https://www.inphms.com";
const imgUrl = "https://download.inphmscdn.com/icons/website/static/description/icon.png";
...
describe("link", () => {
    describe("range collapsed", () => {
        ...
        test("should replace link for new content (url) when pasting in an empty link (collapsed)", async () => {
            ...
            pasteText(editor, "http://inphms.com");
            await animationFrame();
            await expectElementCount(".o-we-powerbox", 0);
            expect(cleanLinkArtifacts(getContent(el))).toBe(
                `<p>xy<a href="http://inphms.com">http://inphms.com</a>[]z</p>`
            );
        });
        ...
        test("should paste and transform plain text content over an empty link (collapsed)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteText(editor, "abc www.inphms.com xyz");
                },
                contentAfter: '<p>abc <a href="http://www.inphms.com">www.inphms.com</a> xyz[]</p>',
            });
            await testEditor({
                contentBefore: '<p><a href="http://test.test/">[]\u200B</a></p>',
                stepFunction: async (editor) => {
                    pasteText(editor, "inphms.com\ngoogle.com");
                },
                contentAfter:
                    '<div><a href="http://inphms.com">inphms.com</a></div>' +
        ...
        test("should paste html content over an empty link (collapsed)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteHtml(
                        editor,
                        '<a href="www.inphms.com">inphms.com</a><br><a href="google.com">google.com</a>'
                    );
                },
                contentAfter:
                    '<p><a href="www.inphms.com">inphms.com</a></p><p><a href="https://google.com">google.com[]</a></p>',
            });
        });
        test("should paste html content over an empty link (collapsed) (2)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteHtml(
                        editor,
                        '<a href="www.inphms.com">inphms.com</a><br><a href="www.google.com">google.com</a>'
                    );
                },
                contentAfter:
                    '<p><a href="www.inphms.com">inphms.com</a></p><p><a href="www.google.com">google.com[]</a></p>',
            });
        });
    ...
    describe("range not collapsed", () => {
        ...
        test("should restore selection when pasting plain text followed by UNDO (2) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "www.inphms.com");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should restore selection when pasting plain text followed by UNDO (3) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "def www.inphms.com xyz");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should paste and transform plain text content over a link if all of its contents is selected (not collapsed)", async () => {
            await testEditor({
                ...
                contentAfter: '<p><a href="http://www.inphms.com">www.inphms.com</a>[]</p>',
            });
            await testEditor({
                contentBefore: '<p><a href="#">[xyz]</a></p>',
                stepFunction: async (editor) => {
        ...
        test("should paste and transform plain text content over an image link if all of its contents is selected (not collapsed) (1)", async () => {
            ...
            await expectElementCount(".o-we-powerbox", 1);
            expect(getContent(el)).toBe(
                `<p>abhttps://download.inphmscdn.com/icons/website/static/description/icon.png[]cd</p>`
            );
            await press("Enter");
...
describe("Inphms editor own html", () => {
    test("should paste html as is", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteInphmsEditorHtml(editor, '<div class="custom-paste oe_unbreakable">b</div>');
            },
    ...
    test("should not paste unsafe content", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteInphmsEditorHtml(editor, `<script>console.log('xss attack')</script>`);
            },
...
describe("editable in iframe", () => {
    test("should paste inphms-editor html", async () => {
        const { el, editor } = await setupEditor("<p>[]</p>", { props: { iframe: true } });
        pasteInphmsEditorHtml(editor, `<p>text<b>bold text</b>more text</p>`);
    ...
    <head>
        ...
        <style>
            ...
            .font12 {
                ...
                font-style: italic;
                text-decoration: none;
                font-family: "Inphms Unicode Support Noto";
    ...
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" border="1"
        ...
        <tbody>
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Inphms Unicode Support Noto;font-weight:normal;font-style:italic;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Inphms Unicode Support Noto;font-weight:bold;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;background-color:#ffff00;font-family:Inphms Unicode Support Noto;font-weight:normal;color:#495057;"
...
describe("onDrop", () => {
    ...
    test("should move an image if it originated from the editor", async () => {
        ...
        await animationFrame();
        const imageHTML = dragdata.getData("application/vnd.inphms.inphms-editor-node");
        ...
        // Simulate the application/vnd.inphms.inphms-editor-node data that the browser would do.
        dropData.setData("application/vnd.inphms.inphms-editor-node", imageHTML);
        await dispatch(pElement, "drop", { dataTransfer: dropData });
        await animationFrame();
