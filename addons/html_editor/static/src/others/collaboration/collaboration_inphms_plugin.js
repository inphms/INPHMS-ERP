...
/**
 * @typedef { Object } CollaborationInphmsShared
 * @property { CollaborationInphmsPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationInphmsPlugin extends Plugin {
    static id = "collaborationInphms";
        ...
        return new PeerToPeer({
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    case "ptp_remove":
                        // todo: to implement
                        // this.inphmsEditor.multiselectionRemove(notificationPayload);
                        break;
                    case "ptp_disconnect":
                        this.ptp.removePeer(fromPeerId);
                        // todo: to implement
                        // this.inphmsEditor.multiselectionRemove(fromPeerId);
                        break;
    ...
    async resetFromServerAndResyncWithPeers() {
        ...
        // lastHistoryId will be different if the inphms bus did not have time to
        // notify the user.
    ...
    showConflictDialog() {
        ...
        //     return;
        // }
        // const content = markup(this.inphmsEditor.editable.cloneNode(true).outerHTML);
