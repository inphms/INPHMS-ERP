...
export class ColumnPlugin extends Plugin {
    ...
    resources = {
        ...
        hints: [
            {
                selector: `.inphms-editor-editable .o_text_columns div[class^='col-'],
                            .inphms-editor-editable .o_text_columns div[class^='col-']>${baseContainerGlobalSelector}:first-child`,
