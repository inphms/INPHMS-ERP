...
from inphms.tools._vendor.parse_version import parse_version
...
try:
    ...
    # The most common type of patch occurs when the phonenumbers library is updated, but Inphms is still using an older version.
