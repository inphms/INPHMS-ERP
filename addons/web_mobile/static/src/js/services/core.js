/* global InphmsDeviceUtility */

import { uniqueId } from "@web/core/utils/functions";
import { browser } from "@web/core/browser/browser";
import { parseSearchQuery } from "@web/core/browser/router";

var available = typeof InphmsDeviceUtility !== 'undefined';
var DeviceUtility;
var deferreds = {};
export var methods = {};

if (available){
    DeviceUtility = InphmsDeviceUtility;
    delete window.InphmsDeviceUtility;
}
 ...
 * @param {Object} result
 */
window.inphms.native_notify = function (id, result) {
