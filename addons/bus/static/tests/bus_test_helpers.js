import { after, expect, registerDebugInfo } from "@inphms/hoot";
import { Deferred } from "@inphms/hoot-mock";
import {
    MockServer,
    asyncStep,
    defineModels,
...
import { on, runAllTimers, waitUntil } from "@inphms/hoot-dom";
...
/** @type {Record<string, (env: InphmsEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<InphmsEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: InphmsEnv, id: string, payload: any) => any} handler
 */
