...
from inphms.addons.base.models.res_company import ResCompany
from inphms.addons.base.models.res_users import ResUsers
from inphms.tools.pdf import ArrayObject, NumberObject, NameObject,  ByteStringObject, DictionaryObject, create_string_object, DecodedStreamObject as StreamObject, \
    PdfReader, PdfWriter
...
class PdfSigner:
    ...
    def sign_pdf(self, visible_signature: bool = False, field_name: str = "Inphms Signature", signer: Optional[ResUsers] = None) -> Optional[io.BytesIO]:
