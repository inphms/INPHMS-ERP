...
def float_round(  # type: ignore[misc]
    value: float,
    precision_digits: int | None = None,
    precision_rounding: float | None = None,
...
def float_is_zero(  # type: ignore[misc]
    value: float,
    precision_digits: int | None = None,
    precision_rounding: float | None = None,
) -> bool:
...
def float_compare(  # type: ignore[misc]
    value1: float,
    value2: float,
    precision_digits: int | None = None,
    precision_rounding: float | None = None,
...
def float_split_str(value: float, precision_digits: int) -> tuple[str, ...]:
