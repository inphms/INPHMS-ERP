...
from inphms.modules import Manifest, Registry, SUPERUSER_ID, Environment
from inphms.modules.utils import MANIFEST_NAMES
...
class Cloc(object):
    ...
    def count_modules(self, env):
        ...
        exclude_path = {
            ...
            if (m := Manifest.for_addon(name, display_warning=False))
        }
    ...
    def count_customization(self, env):
        ...
        # the module should be inphms/studio unless it comes from an imported module install
    ...
    def report(self, verbose=False, width=None):
        ...
        # Render
        s = fmt.format(k="Inphms cloc", lines="Line", other="Other", code="Code")
        s += hr
