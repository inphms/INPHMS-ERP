...
from .garbagecollector import disabling_gc
...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching Inphms.
    """
    name = 'traces_sync'
    ...
    def end(self):
        ...
        try:
            ...
            if self.db:
                ...
                from inphms.databases import db_connect, SQL # only import from inphms if/when needed.
