...
class inphms_resolver(etree.Resolver):
    """Inphms specific file resolver that can be added to the XML Parser.
...
def _check_with_xsd(tree_or_str, stream, env=None, prefix=None):
    ...
    :param inphms.api.Environment env: If it is given, it enables resolving the
    ...
    if env:
        parser.resolvers.add(inphms_resolver(env, prefix))
...
def load_xsd_files_from_url(env, url, file_name=None, force_reload=False,
    ...
    :param inphms.api.Environment env: environment of calling module
    ...
    :rtype: inphms.api.ir.attachment | bool
...
def validate_xml_from_attachment(env, xml_content, xsd_name, reload_files_function=None, prefix=None):
    ...
    :param inphms.modules.Environment env: environment of calling module
    ...
    :return: the result of the function :func:`inphms.tools.xml_utils._check_with_xsd`
    """
