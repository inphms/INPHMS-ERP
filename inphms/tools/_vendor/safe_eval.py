...
_BUBBLEUP_EXCEPTIONS = (
    inphms.exceptions.UserError,
    inphms.exceptions.RedirectWarning,
...
`inphms.tools.safe_eval.wrap_module` to generate a wrapper recursively
whitelisting allowed attributes.

Pre-wrapped modules are provided as attributes of `inphms.tools.safe_eval`.
""")
    return d
...
from inphms._monkeypatches.pytz import patch_module as patch_pytz  # noqa: E402, F401
patch_pytz()
