...
from ..field import Field, _logger
from ..utils import COLLECTION_TYPES
from ...utils import parse_field_expr, SQL_OPERATORS
from .utils import Property, check_property_field_value_name
from inphms.databases import SQL
from inphms.tools import html_sanitize, OrderedSet, is_list_of, has_list_types
from inphms.exceptions import AccessError, UserError, MissingError
...
class Properties(Field):
    ...
    like Inphms fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~inphms.fields.PropertiesDefinition`
