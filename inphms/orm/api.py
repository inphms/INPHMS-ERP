...
def constrains(*args) -> Decorator:
    """Decorate a constraint checker.
        ...
        Should raise :exc:`~inphms.exceptions.ValidationError` if the
        validation failed.
...
def ondelete(*, at_uninstall: bool) -> Decorator:
    """
        Mark a method to be executed during :meth:`~inphms.models.BaseModel.unlink`.
...
def autovacuum(method: C) -> C:
    """
        ...
        as in :meth:`~inphms.addons.base.models.ir_cron.IrCron._commit_progress`.
    """
