...
class Form:
    ...
    * properly handle defaults & onchanges around x2many fields.
    ...
    of :class:`~inphms.fields.Many2one` fields, one can assign a recordset::
    ...
    For :class:`~inphms.fields.Many2many` fields, the field itself is a
    :class:`~inphms.tests.common.M2MProxy` and can be altered by adding or
    removing records::
    ...
    Finally :class:`~inphms.fields.One2many` are reified as :class:`~O2MProxy`.

    Because the :class:`~inphms.fields.One2many` only exists through its parent,
...
class O2MProxy(X2MProxy):
    ...
    def new(self):
        ...
        :class:`~inphms.fields.One2many` record, properly initialised.
    ...
    def edit(self, index):
        ...
        :class:`~inphms.fields.One2many` record.
