...
from inphms.tools.translate import TranslationImporter
from inphms.tools import groupby
...
class BaseLanguageImport(models.TransientModel):
    ...
    def import_lang(self):
        ...
        for overwrite, base_lang_imports in groupby(self, operator.itemgetter('overwrite')):
