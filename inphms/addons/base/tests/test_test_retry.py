...
from inphms.tests import BaseCase, TransactionCase, tagged, BaseCase
from inphms.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when INPHMS_TEST_FAILURE_RETRIES is set"""
