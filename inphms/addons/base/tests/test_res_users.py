...
from inphms.exceptions import AccessError, UserError, ValidationError
from inphms.orm.fields import Command
from inphms.server.utils import _request_stack
from inphms.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users, warmup
...
class TestUsers(UsersCommonCase):
    ...
    @mute_logger('inphms.db', 'inphms.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('inphms.addons.base.models.res_users.request', request)
...
class TestUsers2(UsersCommonCase):
    ...
    @users('portal_1')
    @mute_logger('inphms.addons.base.models.ir_model')
