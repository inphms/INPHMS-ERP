...
from inphms.tests import common
from inphms.tests.common import BaseCase, HttpCase
from inphms.tests.test_cursor import TestCursor
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = Environment(self.cr, SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('inphms.db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:inphms.db:Found different un-closed cursor', msg)
