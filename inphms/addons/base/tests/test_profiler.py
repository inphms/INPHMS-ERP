...
from inphms.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from inphms.tools import profiler
from inphms.tools.profiler import Profiler, ExecutionContext
from inphms.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('inphms.databases.db_connect', return_value=self.registry))
