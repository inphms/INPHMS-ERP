...
from inphms.tests import TransactionCase, tagged, Form


@tagged('-at_install', 'post_install')
class TestFormCreate(TransactionCase):
    """
    Test that the basic Inphms models records can be created on
    the interface.
    """
    ...
    def test_create_res_partner(self):
        ...
        if hasattr(self.env['res.partner'], 'property_account_payable_id'):
            ...
            # https://github.com/inphms/enterprise/commit/68f6c1f9fd3ff6762c98e1a405ade035129efce0
