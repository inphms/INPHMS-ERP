...
from inphms.tests.common import standalone
from inphms.tests.test_module_operations import install
from inphms.tools import mute_logger
from inphms.tools.convertutils import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('inphms.modules.registry'):
