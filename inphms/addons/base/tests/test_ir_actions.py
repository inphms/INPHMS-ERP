...
from inphms.tools import mute_logger
from inphms.tests import common, tagged
from inphms.addons.base.tests.common import TransactionCaseWithUserDemo
...
class TestServerActions(TestServerActionsBase):
    def test_00_server_action(self):
        with self.assertLogs('inphms.addons.base.models.ir_actions.server_action_safe_eval',
                             level='DEBUG') as log_catcher:
            self.test_server_action.run()
            self.assertEqual(log_catcher.output, [
                'DEBUG:inphms.addons.base.models.ir_actions.server_action_safe_eval:This is a test debug log',
                'INFO:inphms.addons.base.models.ir_actions.server_action_safe_eval:This is a test info log',
                'WARNING:inphms.addons.base.models.ir_actions.server_action_safe_eval:This is a test warning log',
                'ERROR:inphms.addons.base.models.ir_actions.server_action_safe_eval:This is a test error log',
"""ERROR:inphms.addons.base.models.ir_actions.server_action_safe_eval:This is a test exception log
...
ZeroDivisionError: division by zero""" % self.test_server_action.id
    ...
    @mute_logger('inphms.addons.base.models.ir_model', 'inphms.models')
    ...
    def test_90_webhook(self):
        ...
        with patch.object(requests, 'post', _patched_post), mute_logger('inphms.addons.base.models.ir_actions'):
            # first run: 200
            self.action.with_context(self.context).run()
...
class TestCustomFields(TestCommonCustomFields):
    def test_create_custom(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('inphms.db'):
    ...
    @mute_logger('inphms.addons.base.models.ir_ui_view')
...
class TestCustomFieldsPostInstall(TestCommonCustomFields):
    def test_add_field_valid(self):
        ...
        with self.assertLogs('inphms.registry') as log_catcher:
