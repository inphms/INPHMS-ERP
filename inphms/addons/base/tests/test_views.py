...
from inphms.exceptions import AccessError, ValidationError
from inphms.tests import common, tagged
from inphms.addons.base.tests.common import TransactionCaseWithUserDemo
from inphms.tools import mute_logger, view_validation
from inphms.tools._vendor.safe_eval import safe_eval
from inphms.tools.orm import get_cache_key_counter
from inphms.addons.base.models import ir_ui_view
...
class ViewCase(TransactionCaseWithUserDemo):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False, model='ir.ui.view'):
        with mute_logger('inphms.addons.base.models.ir_ui_view'):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view', model='ir.ui.view'):
        with self.assertLogs('inphms.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': model,
                'arch': arch,
...
class ViewModifiers(ViewCase):
    ...
    def test_05_modifier_attribute_priority(self):
        ...
        for type_value, context, expected in [
            ...
            result = safe_eval(result, {'context': context, 'type': type_value})
