...
from inphms.addons.base.models.res_partner import ResPartner
from inphms.addons.base.tests.common import TransactionCaseWithUserDemo
from inphms.exceptions import AccessError, RedirectWarning, UserError, ValidationError
from inphms.tests import Form
from inphms.tests.common import new_test_user, tagged, TransactionCase, users
...
class TestPartner(TransactionCaseWithUserDemo):
    ...
    def test_main_user_id(self):
        """Test main_user_id compute, including InphmsBot special case and priority among several users."""
