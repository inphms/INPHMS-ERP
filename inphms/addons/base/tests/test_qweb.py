...
from inphms.addons.base.models.ir_qweb import QWebError
from inphms.tools import file_open, mute_logger, html_escape
from inphms.tools.json import scriptsafe as json_scriptsafe
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://inphms.com/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/inphms/sub">link</a>
                <a href="/link/inphms/">link2</a>
            """
        values = {'url': 'inphms', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('inphms.addons.base.models.ir_qweb')
    ...
    @mute_logger('inphms.addons.base.models.ir_qweb') # warning for template not found
