...
from inphms.addons.base.models.ir_attachment import IrAttachment
from inphms.addons.base.tests.common import TransactionCaseWithUserDemo
from inphms.tools import mute_logger
from inphms.tools.imageutils import image_to_base64
...
class TestIrAttachment(TransactionCaseWithUserDemo):
    ...
    def test_10_image_autoresize(self):
        ...
        with Image.open(os.path.join(dir_path, 'inphms.jpg'), 'r') as logo:
...
class TestPermissions(TransactionCaseWithUserDemo):
    ...
    @mute_logger("inphms.addons.base.models.ir_rule", "inphms.models")
