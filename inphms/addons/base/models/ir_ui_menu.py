...
class IrUiMenu(models.Model):
    ...
    group_ids = fields.Many2many('res.groups', 'ir_ui_menu_group_rel',
                                 ...
                                 help="If you have groups, the visibility of this menu will be based on these groups. "\
                                      "If this field is empty, Inphms will compute visibility based on the related object's read access.")
    ...
    def create(self, vals_list):
        ...
        for values in vals_list:
            ...
            if 'submenu_icon' in values:
                values['submenu_icon'] = self._compute_submenu_svg_icon(values.get('submenu_icon'))
    ...
    def write(self, vals):
        ...
        if 'submenu_icon' in vals:
                vals['submenu_icon'] = self._compute_submenu_svg_icon(vals.get('submenu_icon'))
    ...
    def _compute_submenu_svg_icon(self, submenu_icon):
        if submenu_icon and len(submenu_icon.split(',')) == 2:
            return self._read_image(submenu_icon)
    ...
    def load_menus(self, debug):
        ...
        for menu in visible_menus:
            ...
            submenu_icon = False
            if menu.submenu_icon:
                submenu_icon = Markup(base64.b64decode(menu.submenu_icon).decode('utf-8'))
