...
from inphms.tools.translate import code_translations, _
from .utils import REFERENCING_FIELDS, FakeField, exclude_ref_fields, only_ref_fields, ImportWarning
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        callable taking a record-ish (a dictionary representing an inphms
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`inphms.models.Model.write` expects.

        :param model: :class:`inphms.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`inphms.fields.Field`
