...
from .utils import _tzs, _lang_get, EU_EXTRA_VAT_CODES, ADDRESS_FIELDS
from inphms.modules import SUPERUSER_ID
from inphms.tools import _
from inphms.exceptions import ValidationError, RedirectWarning, UserError
...
if t.TYPE_CHECKING:
    ...
    from .categ import ResPartnerCategory
    from .industry import ResPartnerIndustry
...
class ResPartner(models.Model):
    ...
    def _compute_main_user_id(self):
        for partner in self:
            ...
            # Special case for InphmsBot as its user might be archived.
    ...
    def _compute_email_formatted(self):
        ...
        for partner in self:
            ...
            if emails_normalized:
                ...
                # but this is current behavior in Inphms 14+ and some servers allow it
    ...
    def write(self, vals):
        if vals.get('active') is False:
            ...
            # https://github.com/inphms/inphms/commit/9d7226371730e73c296bcc68eb1f856f82b0b4ed
            #
