...
from inphms.exceptions import ValidationError, AccessError
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - inphms/addons/test_access_rights/tests/test_feedback.py
        # - inphms/addons/test_access_rights/tests/test_ir_rules.py
        # - inphms/addons/base/tests/test_orm.py (/home/dle/src/inphms/master-nochange-fp/inphms/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            ...
            if suggested_companies and len(suggested_companies) != 1:
                resolution_info += _('\n\nNote: this might be a multi-company issue. Switching company may help - in Inphms, not in real life!')
