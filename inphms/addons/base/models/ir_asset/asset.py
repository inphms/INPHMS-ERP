...
from .utils import APPEND_DIRECTIVE, AFTER_DIRECTIVE, PREPEND_DIRECTIVE, BEFORE_DIRECTIVE, \
    REMOVE_DIRECTIVE, REPLACE_DIRECTIVE, INCLUDE_DIRECTIVE, DIRECTIVES_WITH_TARGET, \
    DEFAULT_SEQUENCE, AssetPaths, can_aggregate, fs2web, is_wildcard_glob, _glob_static_file, _logger
from ..utils import EXTERNAL_ASSET, ASSET_EXTENSIONS
from inphms.tools import topological_sort
...
class IrAsset(models.Model):
    ...
    def _topological_sort(self, addons_tuple):
        ...
        return topological_sort({manif['name']: tuple(manif['depends']) for manif in manifs})
    ...
    def _get_installed_addons_list(self):
        ...
        """
        return self.env.registry._init_modules.union(config['server_wide_modules'])
    ...
    def _get_paths(self, path_def, installed):
        ...
        Ex: ('/base/static/file.js', '/home/user/source/inphms/inphms/addons/base/static/file.js', 643636800)
