...
from inphms.tools import file_open, replace_exceptions, verify_limited_field_access_token
from inphms.tools.mimetypes import get_extension, guess_mimetype
from inphms.server.utils import request
from inphms.server.streaming import Stream
from inphms.tools.imageutils import image_process, image_guess_size_from_field_name
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:inphms.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~inphms.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`inphms.tools.image.image_process`.
